...
using JanuszMarcinik.Mvc.WebUI.Areas.Identity.Models.Account;

namespace JanuszMarcinik.Mvc.WebUI.Areas.Identity.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        private UsersService _userManager;

        public AccountController()
        {
        }

        public AccountController(UsersService userManager, SignInService signInManager)
        {
        ...
        public UsersService UserManager
        {
            get
            {
                var ddd = HttpContext.GetOwinContext().Authentication.User.Identity.GetUserId();
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<UsersService>();
            }
            private set
            {
                _userManager = value;
